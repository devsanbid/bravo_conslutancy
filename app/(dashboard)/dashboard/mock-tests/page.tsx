...
import { FileText, Headphones, PenTool, Mic, Search, Calendar, Clock } from "lucide-react";
    ...
    <div className="container mx-auto py-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Practice with our mock tests to improve your skills</p>
        </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              {!searchQuery && activeTab !== "all" && (
                <p className="text-sm mt-2">No {activeTab} tests are currently available.</p>
              )}
            </div>
          ) : (
              ...
              {filteredTests().map((test) => (
                <Card key={test.id} className="overflow-hidden flex flex-col">
                  <div className={`h-2 w-full ${
                    test.category === "reading" ? "bg-blue-500" :
                    test.category === "listening" ? "bg-green-500" :
                    test.category === "writing" ? "bg-purple-500" :
                    "bg-orange-500"
                  }`} />
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-2">
                        <div className={`p-2 rounded-full ${
                          ...
                          test.category === "listening" ? "bg-green-100 text-green-700" :
                          test.category === "writing" ? "bg-purple-100 text-purple-700" :
