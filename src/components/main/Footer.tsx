        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              Bravos International offers innovative solutions in various industries, simplifying lives in Nepal and
              globally through education, management, tourism, services, and more.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-600">
                ...
                <span>Manbhawan 03, Lalitpur Nepal</span>
              </li>
              <li className="flex items-start gap-3 text-gray-600">
                <Phone className="w-5 h-5 text-[#C25934] mt-1" />
                <span>+977 - 9801256293 / 9801256294</span>
              </li>
              <li className="flex items-start gap-3 text-gray-600">
