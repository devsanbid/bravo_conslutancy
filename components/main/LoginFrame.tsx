              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight">
                    <span className="text-brand-purple">Welcome</span> <span className="text-brand-orange">Back</span>
                  </h1>
                  <p className="text-brand-purple/80 max-w-sm">Sign in to continue your learning journey with us.</p>
                </div>
            ...
            <div className="lg:col-span-3 flex items-center justify-center p-6 lg:p-8">
              <div className="w-full max-w-md space-y-8">
                <Alert className="bg-brand-purple/5 text-brand-purple border-brand-purple/20">
                  ...
                  <AlertDescription>Please enter your credentials to access your account.</AlertDescription>
                </Alert>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <div className="flex items-center justify-between">
                              <FormLabel className="text-brand-purple">Password</FormLabel>
                              <Link
                                href="/forgotpassword"
                ...
                <div className="space-y-6">
                  ...
                  <Button type="button" variant="outline" size="lg" className="w-full h-12">
